...
function previewFive(){
  ...
  lastFigure.style.position="abolute";
  ...
  articleE1.insertBefore(lastFigure,
  ...
  articleE1.insertBefore(firstFigure,
    document.getElementById("fig2"));
  //add appropiate src vaules to two new img elements 
...
/* create event listerners for the left arrow, right arrow and center figure elements */
...
function zoomFig() {
  ...
  var winTop=((screen.width-propertyWidth)/2);
